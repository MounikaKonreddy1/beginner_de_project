...
git clone https://github.com/MounikaKonreddy1/beginner_de_project.git
...
For the [continuous delivery](https://github.com/MounikaKonreddy1/beginner_de_project.git/blob/master/.github/workflows/cd.yml) to work, set up the infrastructure with terraform, & defined the following repository secrets. You can set up the repository secrets by going to `Settings > Secrets > Actions > New repository secret`.
